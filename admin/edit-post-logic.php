...
if (isset($_POST['submit'])) {
    ...
    if (!$title) {
        $_SESSION['edit-post'] = "No se pudo actualizar el post. Formato inválido.";
    } elseif (!$category_id) {
        $_SESSION['edit-post'] = "No se pudo actualizar el post. Formato inválido.";
    } elseif (!$body) {
        $_SESSION['edit-post'] = "No se pudo actualizar el post. Formato inválido.";
        ...
        if ($thumbnail['name']) {
            ...
            if (in_array($extension, $allowed_files)) {
                ...
                if ($thumbnail['size'] < 2000000) {
                    ...
                    $_SESSION['edit-post'] = "No se pudo actualizar el post. La imagen es demasiado grande.";
                }
            } else {
                $_SESSION['edit-post'] = "No se pudo actualizar el post. La imagen debe de ser en formato png, jpg o jpeg.";
            }
        }
    }
    ...
    if (!mysqli_errno($connection)) {
        $_SESSION['edit-post-success'] = "Post actualizado éxitosamente";
    }
}
