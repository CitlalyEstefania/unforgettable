...
$query = "SELECT * FROM users WHERE NOT id=$current_admin_id AND checked=0";
    ...
    <div class="container dashboard__container">
        ...
        <ul>
                ...
                <?php if (isset($_SESSION['user_is_admin'])) : ?>
                    ...
                    <li>
                        <a href="manage-user-checked.php" class="active"><i class="uil uil-user-check"></i>
                    ...
                    <tbody>
                        <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                            <tr>
                                ...
                                <td><?= $user['checked'] ? 'Yes' : 'No' ?></td>
                                <td><a href="<?= ROOT_URL ?>admin/check-user.php?id=<?= $user['id'] ?>" class="btn sm">✓</a></td>
                            </tr>
                        <?php endwhile ?>
                    </tbody>
                </table>
